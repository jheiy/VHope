...
from src.constants import DIALOGUE_TYPE_P_REFLECT_ENJOY, EVENT_ACTION, EVENT_CREATION, EVENT_DESCRIPTION


class PReflectEnjoyDialogueTemplate(DialogueTemplate):

    def __init__(self, id=-1, template=[], relation=[], blanks=[], nodes=[], dependent_nodes=[]):
        DialogueTemplate.__init__(self, id, DIALOGUE_TYPE_P_REFLECT_ENJOY, template, relation, blanks, nodes, dependent_nodes);
