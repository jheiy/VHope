...
class PReflectGratefulYesDialogueTemplate(DialogueTemplate):

    def __init__(self, id=-1, template=[], relation=[], blanks=[], nodes=[], dependent_nodes=[]):
        DialogueTemplate.__init__(self, id, DIALOGUE_TYPE_P_REFLECT_GRATEFUL_YES, template, relation, blanks, nodes,
                                  dependent_nodes);
