...
class EReflectActivityDialogueTemplate(DialogueTemplate):

    def __init__(self, id=-1, template=[], relation=[], blanks=[], nodes=[], dependent_nodes=[]):
        DialogueTemplate.__init__(self, id, DIALOGUE_TYPE_E_REFLECT_ACTIVITY, template, relation, blanks, nodes,
                                  dependent_nodes);
