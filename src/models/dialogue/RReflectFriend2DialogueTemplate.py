...
class RReflectFriend2DialogueTemplate(DialogueTemplate):

    def __init__(self, id=-1, template=[], relation=[], blanks=[], nodes=[], dependent_nodes=[]):
        DialogueTemplate.__init__(self, id, DIALOGUE_TYPE_R_REFLECT_FRIEND2, template, relation, blanks, nodes,
                                  dependent_nodes);
