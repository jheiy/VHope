...
class VHope:
    ...
    def get_response(self):
        ...
        # response_text = "hey_comma_ how are you?"
        # response_text = orsen.get_response(usr_text, move_to_execute = 'low_perma')
        ...
        if "_comma_" in response_text:
            response_text = response_text.replace("_comma_", ",")
        if "_comm_" in response_text:
            response_text = response_text.replace("_comm_", ",")
        
        session['past_utterance'] = usr_text
        session['past_fter'] = response_text
